...
Head over to our [GitHub Releases](https://github.com/warden-protocol/connect/releases) page and download the binary that matches your machine's architecture.
