...
First, add the [x/marketmap](https://github.com/warden-protocol/connect/blob/main/x/marketmap/README.md) and [x/oracle](https://github.com/warden-protocol/connect/tree/main/x/oracle) keepers to the application.
